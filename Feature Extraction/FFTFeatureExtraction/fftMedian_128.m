load('all_trucks_raw.mat');

RavMedianDataSet = zeros(32, 256);
%% Preprocessing
for rawSignalIndex = 1:32
    dataReduced = RawMotorbike(:, rawSignalIndex);
    %Remove bias
    ...
    featureVectorMedian = sortedFFTVector(1:256);
